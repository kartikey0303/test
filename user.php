...
<div class="back_top">
    ...
    <div id="sr" style="float:right">
  <a class="waves-effect waves-light btn tras" style="padding-right:10px;;letter-spacing:0px">Logout</a>
</div>
<div id="sr" style="width:50%">
	<a href="profile.html" style="letter-spacing:2px;font-size:30px;" class="white-text">Hi,</a>
</div>
<div id="sr" style="width:50%">
  <a href="profile.html" style="letter-spacing:2px;font-size:30px;" class="white-text">[name]</a>
</div>
</div>
